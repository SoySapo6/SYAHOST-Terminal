...
<div style="font-family: monospace; line-height: 1.6;">
  ...
  <div style="color: orange; font-weight: bold;">&nbsp;&nbsp;MayShell</div>
  <div style="color: blue;">══════════</div>
  <br>
  <div><span style="color: orange;">• Usuario:</span> <span style="color: blue;">${user.username}</span></div>
  <div><span style="color: orange;">• Sesión:</span> <span style="color: blue;">${user.sessionId}</span></div>
</div>
`);
